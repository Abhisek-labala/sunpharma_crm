...
class misController extends Controller
{
    ...
    {
        return view('mis.createEducator');
    }
    public function miscreateHcpView()
    {
        return view('mis.createHcp');
    }
    public function miscreateRmView()
    {
        return view('mis.createRm');
    }
    public function miscreateDigitalEducatorView()
    {
        return view('mis.createDigitalEducator');
    }
    public function misfeedback()
    {
        // Your logic here
        return view('mis.feedback');
    }
    public function miscampReport()
    {
        // Your logic here
    ...
    public function misgenderDistribution()
    {
        // Brand medicines
    ...
    public function miscampDistribution()
    {
        $user_id = Auth::id();
    ...
    public function misbloodPressure(Request $request)
    {
    ...
    public function misobesityMetrics(Request $request)
    {
    ...
    public function misdoctorNotMetrics(Request $request)
    {
    ...
    public function mistopeducators()
    {
    ...
    public function misnoteducator(Request $request)
    {
    ...
    public function misPatientList(Request $request)
    {
        return view('mis.mispatientlist');
    }
    ...
    {
        return view('mis.feedbackReport');
    }
