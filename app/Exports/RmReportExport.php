...
class RmReportExport implements FromCollection, WithHeadings, WithMapping
{
    protected $fromDate;
    protected $toDate;
    protected $hcp;
    ...
    public function headings(): array
    {
       $this->calculateMaxPrescriptionFiles();
        ...
        $headings = array_merge($headings, [
            ...
            'Weight', 'Height', 'Waist Circumference', 'BMI', 'Waist to Height Ratio', 'Metabolic Age', 'Co-morbidities', 'Remark'
        ]);
        return $headings;
    }
}
