...
<div class="main-wrapper">
                    ...
                    <form action="nc-Create-Doctor-Post" name="createDoctor" id="createDoctor" method="post"
                        ...
                        <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="required-star">Doctor Consent<span class="text-danger">*</span></label>
    ...
    <script>
        ...
        async function loadState(selectedStateName = null) {
            try {
                let response = await $.post("{{ route('common.getState') }}", {
                    _token: $('input[name="_token"]').val()
                });
        ...
        if (!$(this).find('span.text-danger').length) {
