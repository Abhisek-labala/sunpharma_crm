                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <button type="button" class="btn btn-primary float-right" data-toggle="modal"
                                ...
                                <i class="fa fa-plus"></i> Add Digital Counsellor
                            </button>
                        </div>
                        <div class="card-body">
...
<script>
    ...
    function resetForm() {
        ...
        $('#modalTitle').text('Add DigitalCounsellor');
    ...
    function deleteEducator() {
        ...
        $.ajax({
            url: 'admin-Delete-DigiEducator/' + id,
            type: 'POST',
            dataType: 'json',
            data: {
    ...
    $('#createEducator').submit(function (e) {
        ...
        if (validateEducatorForm()) {
            ...
            var url = $('#educator_id').val() ? 'admin-Update-DigiEducator-Post' : 'admin-Create-DigiEducator-Post';
    ...
    function editRecord(id) {
        ...
        if (!rowData) {
            toastr.error("Counsellor not found");
            return;
        }
