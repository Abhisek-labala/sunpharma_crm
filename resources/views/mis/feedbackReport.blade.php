...
<script>
    ...
    function populateFilters() {
        $.getJSON('{{ route("misgetEducatorsname") }}', function(data) {
        ...
        $.getJSON('{{ route("misgetdigiEducatorsname") }}', function(data) {
    ...
    $(document).ready(function () {
        ...
        const table = $('#feedbackTable').DataTable({
            ...
            ajax: {
                url: '{{ url("admin-Feedback-Details") }}',
                type: 'POST',
                data: function (d) {
    ...
    function downloadFeedbackReport() {
        ...
        const url = '{{ route("admin-feedback-report-excel") }}' +
