...
<div class="header">
    @php
        ...
        $profileData = Rmuser::where('emp_id', $educatorId)->first();
        $profileImage = asset('uploads/logo/user_icon.jpg');
    @endphp

    <!-- Logo -->
    <div class="header-left">
        <a href="{{ route('dashboard.rm') }}" class="logo">
            <img src="{{ asset('uploads/logo/logo.png') }}" alt="Logo">
        </a>
        <a href="{{ route('dashboard.rm') }}" class="logo logo-small">
            ...
            <div class="dropdown-menu">
                <div class="user-header">
                    ...
                    <div class="user-text">
                        ...
                        <p class="text-muted mb-0">Regional Coordinator</p>
                    </div>
                </div>
                <form id="logout-form1" action="{{ route('rmlogout') }}" method="POST" class="d-none">
                    @csrf
                </form>
