    ...
    $(document).ready(function () {
        ...
        let patientTable = $('#patientTable').DataTable({
           processing: true,
            ...
            ajax: {
                url: "{{ route('common.getyogaeduPatientTable') }}",
                type: "POST",
                data: function (d) {
                    return $.extend({}, d, {
        ...
        function loadCamps() {
            $.post("{{ route('common.getyogaCampbyeducator') }}", {
        ...
        function loadZones() {
            $.post("{{ route('common.getyogaZones') }}", {
                _token: $('input[name="_token"]').val()
            }, function (data) {
                $('#zone').html(data);
        ...
        $('#zone').on('change', function () {
            $.post("{{ route('common.getrmsbyyogazone') }}", {
                zone: $(this).val(),
                _token: $('input[name="_token"]').val()
            }, function (data) {
                $('#rm').html(data);
        ...
        $('#rm').on('change', function () {
            $.post("{{ route('common.getEducatorbyyogazoneandRm') }}", {
                rm: $(this).val(),
                zone: $('#zone').val(),
                _token: $('input[name="_token"]').val()
            }, function (data) {
        ...
        $('#campId').on('change', function () {
            $.post("{{ route('common.getDoctorsyogaByEdu') }}", {
                educatorId: $('#educator').val(),
                _token: $('input[name="_token"]').val()
            }, function (data) {
                $('#doctor').html(data);
