...
<div class="header">
    ...
    <div class="header-left">
        <a href="{{ route('dashboard.yogaeducator') }}" class="logo">
            <img src="{{ asset('uploads/logo/logo.png') }}" alt="Logo">
        </a>
        <a href="{{ route('dashboard.yogaeducator') }}" class="logo logo-small">
            ...
            <div class="dropdown-menu">
                <div class="user-header">
                    ...
                    <div class="user-text">
                        ...
                        <p class="text-muted mb-0">Yoga Digital Dietician</p>
                    </div>
                </div>
