                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-md-7">
                                                <input type="text" placeholder="Waist circumference In Cm"
                                                    maxlength="10" class="form-control" onkeydown="calculateWH()"
    ...
    $(document).ready(function () {
        ...
        $.ajax({
            ...
            success: function (response) {
                let campValue = (response.campId && response.campId.camp_id) ? response.campId.camp_id : '';
                $('#campId').val(campValue);
                loadHCPNames();
                loadAges();
                loadMedicines();
                loadCompetitors();
            ...
            error: function (xhr) {
                toastr.error('Error fetching camp ID:', xhr.responseText);
