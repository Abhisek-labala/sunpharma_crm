...
<div class="header">
    @php
        ...
        if ($profileData && $profileData->profile_image) {
            $profileImage = asset('uploads/' . $profileData->profile_image);
        }
    @endphp

    <!-- Logo -->
    <div class="header-left">
        <a href="{{ route('dashboard.digitaleducator') }}" class="logo">
            <img src="{{ asset('uploads/logo/logo.png') }}" alt="Logo">
        </a>
        <a href="{{ route('dashboard.digitaleducator') }}" class="logo logo-small">
            ...
            <div class="dropdown-menu">
                <div class="user-header">
                    ...
                    <div class="user-text">
                        ...
                        <p class="text-muted mb-0">Digital Counsellor</p>
                    </div>
                </div>
